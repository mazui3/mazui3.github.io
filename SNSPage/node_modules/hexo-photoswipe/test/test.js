...
let resultLocal = renderImageResolution(localImageTestCase, "title1", hexo.config);
...
let resultNetwork = renderImageResolution(networkImageTestCase, "title2", hexo.config);
